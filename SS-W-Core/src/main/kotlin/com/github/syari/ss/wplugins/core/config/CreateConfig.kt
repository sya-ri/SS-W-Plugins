...
object CreateConfig {
     ...
     */
    fun config(
        plugin: Plugin, output: CommandSender, fileName: String, deleteIfEmpty: Boolean = true, default: Map<String, Any> = emptyMap()
    ): CustomFileConfig {
     ...
     */
    fun config(
        plugin: Plugin, output: CommandSender, fileName: String, deleteIfEmpty: Boolean = true, default: Map<String, Any> = emptyMap(), run: CustomFileConfig.() -> Unit
    ): CustomFileConfig {
     ...
     */
    fun config(
        plugin: Plugin, output: CommandSender, uniqueName: String, reader: Reader
    ): CustomReaderConfig {
     ...
     */
    fun config(
        plugin: Plugin, output: CommandSender, uniqueName: String, reader: Reader, run: CustomReaderConfig.() -> Unit
    ): CustomReaderConfig {
     ...
     */
    fun configDir(
        plugin: Plugin, output: CommandSender, directoryName: String, deleteIfEmpty: Boolean = true
     ...
     */
    fun configDir(
        plugin: Plugin, output: CommandSender, directoryName: String, deleteIfEmpty: Boolean = true, run: CustomFileConfig.() -> Unit
    ) {
